// src/components/AchievementsTimeline.jsx
"use client";
...
export default function AchievementsTimeline() {
    ...
    const activeIndex = achievements.findIndex((a) => a.slug === currentSlug);
        ...
        <aside className="hidden lg:block sticky top-24 h-fit max-h-[calc(100vh-7rem)] w-[280px] -ml-8 xl:-ml-16 2xl:-ml-20">
            ...
            <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-6 backdrop-blur-xl shadow-2xl overflow-hidden">
                ...
                <div className="mb-6">
                    ...
                    <div className="mt-1 h-[2px] w-12 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500" />
                </div>

                {/* Scrollable Timeline Container */}
                <div className="relative max-h-[calc(100vh-20rem)] overflow-y-auto overflow-x-hidden pr-2 scrollbar-hide">
                    {/* Base line - thicker */}
                    <div className="absolute left-[10px] top-2 h-[calc(100%-16px)] w-[2px] bg-gradient-to-b from-blue-500/30 via-blue-500/10 to-transparent" />

                    {/* Active progress line - thicker with glow */}
                    <motion.div
                        className="absolute left-[10px] top-2 w-[2px] bg-gradient-to-b from-blue-400 via-cyan-500 to-blue-600 shadow-[0_0_12px_rgba(59,130,246,0.8)]"
                        initial={{ height: 0 }}
                        animate={{
                            height:
                                activeIndex >= 0
                    ...
                    <ul className="space-y-4">
                        {achievements.map((achievement, index) => {
                            const isActive = achievement.slug === currentSlug;
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute left-0 top-[6px] flex items-center justify-center z-10">
                                        <motion.div
                                            className={`relative h-5 w-5 rounded-full border-2 transition-all duration-300 ${isActive
                                                    ? "border-blue-400 bg-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.6)]"
                                                    : isPassed
                                    ...
                                    >
                                        <motion.div
                                            ...
                                            className={`rounded-lg p-2.5 transition-all duration-300 ${isActive
                                        ...
                                        >
                                            {/* Title */}
                                            <h4
                                                className={`text-sm font-semibold leading-tight transition-colors duration-300 line-clamp-2 ${isActive
                                                        ? "text-blue-300"
                                            ...
                                            {isActive && (
                                                <motion.div
                                                    ...
                                                    className="mt-2 flex items-center gap-1.5 text-[10px] font-medium text-blue-400"
                                                >
                                                    <motion.span
